export const EnMsg = {
    ...
    SENTRY_INDEX: 'index',
    SENTRY_CENTER: 'center ',
    SENTRY_X: 'x-cood',
    SENTRY_Y: 'y-cood',
    SENTRY_WEIGHT: 'min-width',
    SENTRY_HEIGHT: 'min-height',
    SENTRY_COLOR: 'color',
    SENTRY_LABLE: 'label',
    SENTRY_LED_SET_COLOR: 'led detects that the result color is',
    SENTRY_LED_SET_COLOR_NOT: '',
    SENTRY_LED_SET_LEVEL: 'brightness (0~15)',
    ...
    SENTRY_GET_QRCODEVALUE: '  decoding result string',
...
export const EnCatgories = {
    ...
    Sentry1_example_body: EnMsg.SENTRY_VISION_VISIONFACE,
