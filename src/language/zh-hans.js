export const ZhHansMsg = {
    ...
    SENTRY_STATE_VALUE_G: '红色分量值',
    SENTRY_STATE_VALUE_B: '红色分量值',
...
export const ZhHansCatgories = {
    ...
    Sentry1_example_body: ZhHansMsg.SENTRY_VISION_VISIONFACE,
